    ...
    <body style="margin:0; padding:0; background:#f1f5f9; font-family:'Segoe UI',Arial,sans-serif;">
      <div style="max-width:560px; margin:40px auto; background:white; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <div style="background:linear-gradient(135deg,#6366f1,#8b5cf6); padding:40px 32px; text-align:center;">
          <div style="font-size:48px; margin-bottom:12px;">${icons[lead.status]}</div>
        ...
        <div style="padding:36px 32px;">
          ...
          <div style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:12px; padding:20px 24px; margin-bottom:28px;">
            <p style="margin:0 0 8px; color:#94a3b8; font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:1px;">
              Current Status
            </p>
            <div style="display:inline-block; background:${colors[lead.status]}20; color:${colors[lead.status]}; padding:8px 20px; border-radius:20px; font-weight:800; font-size:16px; border:2px solid ${colors[lead.status]}40;">
          ...
          <!-- Notes if any -->
          ${lead.notes ? `
          <div style="background:#f8fafc; border-left:4px solid #6366f1; border-radius:0 12px 12px 0; padding:16px 20px; margin-bottom:28px;">
            <p style="margin:0 0 6px; color:#94a3b8; font-size:12px; font-weight:700; text-transform:uppercase;">
          ...
          <div style="text-align:center; margin-bottom:28px;">
            <a href="http://localhost:5173/track?email=${lead.email}" 
               style="display:inline-block; background:linear-gradient(135deg,#6366f1,#8b5cf6); color:white; text-decoration:none; padding:14px 32px; border-radius:10px; font-weight:700; font-size:15px; box-shadow:0 4px 12px rgba(99,102,241,0.4);">
              Track Your Application →
            </a>
          </div>

          <p style="color:#94a3b8; font-size:13px; text-align:center; margin:0; line-height:1.6;">
            If you have questions, simply reply to this email.<br>
            We're here to help!
          </p>
        </div>
...
// PUT update lead (admin only) - sends email on status change
